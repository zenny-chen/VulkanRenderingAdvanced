...
%VK_SDK_PATH%/Bin/glslangValidator  --target-env vulkan1.1  -Os  -o texture.vert.spv  texture.vert.glsl
%VK_SDK_PATH%/Bin/glslangValidator  --target-env vulkan1.1  -Os  -o texture.frag.spv  texture.frag.glsl
